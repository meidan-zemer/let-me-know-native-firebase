      ...
      if (this.state.loading){
        ...
        return (
          <ScrollView>
            ...
            <LmkInput label={"Contact point name"} value={this.state.name} onChangeText={name=>this.setState({name})}/>
            <LmkInput label={"Contact point description"} value={this.state.description} onChangeText={description=>this.setState({description})}/>
            <LmkInput label={"Your alias"} value={this.state.ownerAlias} onChangeText={ownerAlias=>this.setState({ownerAlias})}/>
